...
var DatesManager = /*#__PURE__*/function () {
  ...
  // get dates
  return _createClass(DatesManager, [{
    key: "getDates",
    ...
    value: function addDate(timestamp) {
      ...
      if (this.isEmpty()) {
        ...
        var keys = Object.keys(this.dates);
        //get the last key in the array then add 1 for the new id. 
        var newId = Number(keys[keys.length - 1]) + 1;
    ...
    key: "saveDates",
    value: function saveDates() {
      var JSONString = JSON.stringify(this.dates);
    ...
    key: "deleteDate",
    value: function deleteDate(id) {
      if (this.validateId(id)) {
        delete this.dates[id];
        console.log(" Date with ID ".concat(id, " has been removed"));
        this.saveDates();
      } else {
    ...
    value: function loadDates() {
      ...
      var retrieve = localStorage.getItem("dates");
      if (retrieve) {
...
var HandlePage = /*#__PURE__*/function () {
  function HandlePage() {
    _classCallCheck(this, HandlePage);
  ...
  return _createClass(HandlePage, [{
    ...
    value: function handleSubmit() {
      ...
      this.submitBtn.addEventListener('click', function () {
        ...
        var newDate = _this.dateInput.value;
...
var Render = /*#__PURE__*/function () {
  ...
  return _createClass(Render, [{
    ...
    value: function createCard() {
      ...
      Object.entries(this.dates).forEach(function (_ref) {
        ...
        card.setAttribute('data-id', "".concat(id));

        // append the strings to the card. 
        var dateText = document.createElement('h3');
        dateText.innerHTML = "".concat(formattedDate);
        var timeText = document.createElement('h2');
        timeText.innerHTML = " ".concat(formattedTime);
        ...
        deleteBtn.setAttribute('data-id', "".concat(id));
        deleteBtn.setAttribute('id', "delete-".concat(id));
        deleteBtn.innerHTML = "<span class=\"material-symbols-outlined\">delete</span>";
        card.appendChild(deleteBtn);
        _this.dateListContainer.appendChild(card);
      });
    }
  }, {
    key: "refreshCards",
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../assets/hero.jpg */ "./src/assets/hero.jpg"), __webpack_require__.b);
...
`, "",{"version":3,"sources":["webpack://./src/styles/style.css"],"names":[],"mappings":"AACA;IACI,mBAAmB;AACvB;AACA;IACI,UAAU;IACV,SAAS;IACT,sBAAsB;IACtB,qCAAqC;AACzC;AACA;IACI,eAAe;AACnB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,kBAAkB,EAAE,gCAAgC;AACxD;;;AAGA;IACI,2EAA6D;IAC7D,sBAAsB;IACtB,YAAY;IACZ,YAAY;IACZ,WAAW;IACX,eAAe;IACf,MAAM;IACN,OAAO;;AAEX;;AAEA;IACI,WAAW;IACX,aAAa;IACb,kBAAkB;IAClB,cAAc;IACd,iBAAiB;IACjB,QAAQ;IACR,OAAO;AACX;;AAEA;IACI,oCAAoC;IACpC,eAAe;AACnB;;AAEA;IACI,wCAAwC;IACxC,oBAAoB;AACxB;;AAEA;IACI,WAAW;IACX,kBAAkB;IAClB,MAAM;IACN,OAAO;IACP,WAAW;IACX,YAAY;IACZ,sCAAsC;IACtC,UAAU;AACd;;;AAGA;IACI,kBAAkB;IAClB,WAAW;IACX,YAAY;IACZ,UAAU;IACV,gBAAgB;IAChB,aAAa;;AAEjB;;AAEA;IACI,yBAAyB;IACzB,WAAW;IACX,YAAY;IACZ,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,oBAAoB;AACxB;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,iCAAiC;IACjC,iBAAiB;IACjB,aAAa;IACb,aAAa;IACb,mBAAmB;IACnB,8CAA8C;IAC9C,sDAAsD;IACtD,mDAAmD;IACnD,mBAAmB;AACvB;;AAEA;IACI,iBAAiB;IACjB,WAAW;IACX,cAAc;IACd,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,aAAa;;IAEb,kBAAkB;IAClB,kBAAkB;IAClB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;IACI,cAAc;IACd,WAAW;IACX,aAAa;IACb,kBAAkB;IAClB,kBAAkB;IAClB,0BAA0B;AAC9B;AACA;IACI,yBAAyB;IACzB,cAAc;AAClB;;AAEA;;IAEI,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,UAAU;IACV,aAAa;IACb,2DAA2D;IAC3D,cAAc;IACd,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,cAAc;IACd,kBAAkB,EAAE,4DAA4D;IAChF,kGAAkG;;IAElG,uCAAuC,EAAE,+BAA+B;AAC5E;;AAEA;IACI,WAAW;IACX,kBAAkB;IAClB,MAAM;IACN,OAAO;IACP,WAAW;IACX,YAAY;IACZ,oGAAoG;IACpG,UAAU;IACV,oCAAoC,EAAE,2BAA2B;IACjE,oBAAoB,EAAE,oDAAoD;;AAE9E;;AAEA;IACI,UAAU,EAAE,4BAA4B;AAC5C;AACA,WAAW,8DAA8D;IACrE,kBAAkB;IAClB,UAAU;AACd;;AAEA;IACI,cAAc;IACd,kBAAkB;IAClB,6BAA6B;IAC7B,kBAAkB;;AAEtB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;AACrB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Jersey+10&family=Jersey+15&family=Reddit+Mono:wght@200..900&family=Space+Grotesk:wght@300..700&display=swap');\n:root {\n    --boxColor: #4c1d95;\n}\n* {\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n    font-family: \"Reddit Mono\", monospace;\n}\n* button {\n    cursor: pointer;\n}\n\nbody,html {\n    width: 100vw;\n    height: 100vh;\n    overflow-x: hidden; /*Prevent horizontal scrolling */\n}\n\n\n.hero {\n    background: url('../assets/hero.jpg') no-repeat center center;\n    background-size: cover;\n    width: 100vw;\n    height: 60vh;\n    z-index: -1;\n    position: fixed;\n    top: 0;\n    left: 0;\n\n}\n\nheader {\n    width: 100%;\n    padding: 30px;\n    text-align: center;\n    color: #cbd5e1;\n    position:absolute;\n    top: 25%;\n    left: 0;\n}\n\nheader h1 {\n    font-family: \"Jersey 15\", sans-serif;\n    font-size: 3rem;\n}\n\nheader h2 {\n    font-family: \"Space Grotesk\", sans-serif;\n    font-weight: lighter;\n}\n\n.hero::before {\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 139, 0.5);\n    z-index: 0; \n} \n\n\n.all-content {\n    position: relative;\n    width: 100%;\n    height: 100%;\n    z-index: 1;\n    margin-top: 50vh;\n    display: flex;\n\n}\n\n.container {\n    background-color: #030712;\n    width: 100%;\n    height: 100%;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    padding-bottom: 48px;\n}\n\n.input-container {\n    position: relative;\n    top: -48px;\n    background-color: var(--boxColor);\n    max-height: 100px;\n    padding: 24px;\n    display: flex;\n    align-items: center;\n    box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75);\n    -webkit-box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75);\n    -moz-box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.75);  \n    margin-bottom: 48px; \n}\n\n.input-container label {\n    text-align: start;\n    margin: 6px;\n    color: #f1f5f9;\n    font-weight: bold;\n    font-size: 1rem;\n}\n\n.input-container input {\n    padding: 10px;\n    \n    border-style: none;\n    border-radius: 8px;\n    font-weight: bold;\n    cursor: pointer;\n}\n\n.input-container button {\n    color: #e2e8f0;\n    margin: 8px;\n    padding: 12px;\n    border-style: none;\n    border-radius: 8px;\n    background-color: #1e293b ;\n}\n.input-container button:hover{\n    background-color: #e2e8f0;\n    color: #1e293b;\n}\n\n.date-list-container {\n\n    width: 100%;\n    height: 100%;\n    position: relative;\n    top: -75px;\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n    grid-gap: 16px;\n    padding: 16px;\n}\n\n.card {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    color: #cbd5e1;\n    position: relative; /* Set position to relative for pseudo-element positioning */\n    background: radial-gradient(circle, rgba(30,58,138,1) 3%, rgba(74,4,78,1) 12%, rgba(3,7,18,1) 23%);\n  \n    transition: background 0.5s ease-in-out; /* Adjusted for demonstration */\n}\n\n.card::after {\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background: radial-gradient(circle, rgba(30,58,138,1) 6%, rgba(74,4,78,1) 21%, rgba(3,7,18,0.5) 56%);\n    opacity: 0;\n    transition: opacity 0.9s ease-in-out; /* Transition the opacity */\n    pointer-events: none; /* Ensure hover effects pass through to the parent */\n\n}\n\n.card:hover::after {\n    opacity: 1; /* Fade in the hover state */\n}\n.card * {  /* Ensure all children of .card are above the pseudo-element */\n    position: relative;\n    z-index: 1;\n}\n\n.card button {\n    color: #cbd5e1;\n    border-style: none;\n    background-color: transparent;\n    visibility: hidden;\n\n}\n\n.card button span {\n    font-size: 1.3rem;\n}\n\n.card h3, .card h2 {\n    user-select: none;\n}\n\n"],"sourceRoot":""}]);
// Exports
...
module.exports = __webpack_require__.p + "assets/d9d63659c6c666becdb8.jpg";
